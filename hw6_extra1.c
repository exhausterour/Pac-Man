/*
  ...
  Course: CSE2010
  Section: 02
  Description: Create a Pacman game that continuous until the death of the pacman or all the point were got
 */
...
int main(int argc, char* argv[])
{
	...
	//loop until all the points has been eaten or pacman is dead
	while((points != max_points) && (pacman->value == 'P')){
		while(true){
	...
	//print pacman is full if all the points were eaten, otherwise print pacman was killed
	if (points == max_points)
		printf("Pac-man is full!\n");
	else
		printf("A ghost is not hungry any more!\n");
